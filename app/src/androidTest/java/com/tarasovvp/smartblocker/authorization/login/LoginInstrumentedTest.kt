...
class LoginInstrumentedTest : BaseInstrumentedTest() {
    ...
    fun checkLoginGoogleAuth() {
        onView(withId(R.id.login_google_auth)).check(matches(isDisplayed()))
            .check(matches(withText(R.string.authorization_enter))).check(
    ...
    @Test
    fun checkLoginEnter() {
        onView(withId(R.id.login_enter)).check(matches(isDisplayed()))
    ...
    fun checkLoginDividerUnauthorized() {
        onView(withId(R.id.login_left_divider_unauthorized)).check(matches(isDisplayed())).check(
            matches(
                withBackgroundColor(
                    ContextCompat.getColor(
                        targetContext,
