...
class DataStoreRepositoryUnitTest {
    ...
    fun setOnBoardingSeenTest() =
        runBlocking {
            ...
            assertEquals(
                isOnBoardingSeen,
                dataStore.data.first()[booleanPreferencesKey(ON_BOARDING_SEEN)],
            )
        }

    @Test
    fun onBoardingSeenTest() =
        runBlocking {
    ...
    fun setCountryCodeTest() =
        runBlocking {
            ...
            assertEquals(
                Gson().toJson(CountryCode()),
                dataStore.data.first()[stringPreferencesKey(COUNTRY_CODE)],
            )
        }
