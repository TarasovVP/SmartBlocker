...
class LogCallRepositoryTest @Inject constructor(private val callDao: LogCallDao){
    ...
    suspend fun getLogCallWithFilterByFilter(filter: String) = callDao.queryCallList(filter).distinctBy { it.call?.number }
