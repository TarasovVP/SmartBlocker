...
class ContactRepositoryTest @Inject constructor(
    ...
    suspend fun getContactsWithFilterByFilter(filter: String) = contactDao.getContactsWithFiltersByFilter(filter)
