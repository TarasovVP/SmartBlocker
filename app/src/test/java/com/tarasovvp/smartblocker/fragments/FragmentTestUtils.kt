...
object FragmentTestUtils {
    ...
    fun callWithFilterUIModelList() = listOf(
        CallWithFilterUIModel(callId = 1, callName = "A Name", number = "+380502711344", type = Constants.IN_COMING_CALL, callDate = "1678603872094",
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "+380502711344", filterType = Constants.BLOCKER, conditionType = FilterCondition.FILTER_CONDITION_FULL.ordinal)
        ),
        CallWithFilterUIModel(callId = 2, callName = "a Name", number = "12345", type = Constants.BLOCKED_CALL, callDate = "1678603872094", isFilteredCall = true, filteredNumber = "12345", conditionType = FilterCondition.FILTER_CONDITION_FULL.ordinal,
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "123", filterType = Constants.BLOCKER, conditionType = FilterCondition.FILTER_CONDITION_START.ordinal)
        ),
        CallWithFilterUIModel(callId = 3,  callName = "B Name", number = "12345", type = Constants.MISSED_CALL, callDate = "1611995776162",
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "123", filterType = Constants.BLOCKER, conditionType = FilterCondition.FILTER_CONDITION_CONTAIN.ordinal, filteredContacts = 11, filteredCalls = 52)
        ),
        CallWithFilterUIModel(callId = 4,  callName = String.EMPTY, number = "12345", type = Constants.REJECTED_CALL, callDate = "1612258705769",
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "12345", filterType = Constants.PERMISSION, conditionType = FilterCondition.FILTER_CONDITION_FULL.ordinal, filteredContacts = 11, filteredCalls = 52)
        ),
        CallWithFilterUIModel(callId = 5,  callName = "C Name", number = "12345", type = "2", callDate = "1612525268071",
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "123", filterType = Constants.PERMISSION, conditionType = FilterCondition.FILTER_CONDITION_START.ordinal)
        ),
        CallWithFilterUIModel(callId = 6, callName = "D Name", number = "12345", type = Constants.BLOCKED_CALL, callDate = "1615110430251",
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "123", filterType = Constants.PERMISSION, conditionType = FilterCondition.FILTER_CONDITION_CONTAIN.ordinal)
        ),
        CallWithFilterUIModel(callId = 7, callName = "Y Name", number = "12345", type = Constants.IN_COMING_CALL, callDate = "1619427342586", filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel())
    )
    ...
    fun contactWithFilterUIModelList() = listOf(
        ...
        ContactWithFilterUIModel(contactId ="3", contactName = "B Name", number = "12345",
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "123", filterType = Constants.BLOCKER, conditionType = FilterCondition.FILTER_CONDITION_CONTAIN.ordinal)
        ),
        ContactWithFilterUIModel(contactId ="4", contactName = "B Name", number = "12345",
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "12345", filterType = Constants.PERMISSION, conditionType = FilterCondition.FILTER_CONDITION_FULL.ordinal)
        ),
    ...
    fun numberDataWithFilteredCallUIModelList() = arrayListOf<NumberDataUIModel>(
        CallWithFilterUIModel(callId = 5,  callName = "C Name", number = "12345", type = "2", callDate = "1612525268071", isFilteredCall = true,
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "123", filterType = Constants.PERMISSION, conditionType = FilterCondition.FILTER_CONDITION_START.ordinal)),
        CallWithFilterUIModel(callId = 6, callName = "D Name", number = "12345", type = Constants.BLOCKED_CALL, callDate = "1615110430251", isFilteredCall = true,
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "123", filterType = Constants.PERMISSION, conditionType = FilterCondition.FILTER_CONDITION_CONTAIN.ordinal)),
        CallWithFilterUIModel(callId = 2, callName = "a Name", number = "12345", type = Constants.BLOCKED_CALL, callDate = "1678603872094", isFilteredCall = true, filteredNumber = "12345", conditionType = FilterCondition.FILTER_CONDITION_FULL.ordinal,
            filterWithFilteredNumberUIModel = FilterWithFilteredNumberUIModel(filter = "123", filterType = Constants.BLOCKER, conditionType = FilterCondition.FILTER_CONDITION_START.ordinal)))

    fun numberDataWithFilterWithFilteredNumberUIModelList() = arrayListOf<NumberDataUIModel>(FilterWithFilteredNumberUIModel(filter = "+380502711344", filterType = Constants.BLOCKER, conditionType = FilterCondition.FILTER_CONDITION_FULL.ordinal, created = 1681315250919, filteredContacts = 3),
        FilterWithFilteredNumberUIModel(filter = "123", filterType = Constants.BLOCKER, conditionType = FilterCondition.FILTER_CONDITION_START.ordinal, created = 1681314350919),
        FilterWithFilteredNumberUIModel(filter = "1234", filterType = Constants.BLOCKER, conditionType = FilterCondition.FILTER_CONDITION_CONTAIN.ordinal, created = 1681314260919))
}