...
class ListContactUseCaseTest {
    ...
    fun getFilteredContactListTest() = runBlocking {
        val contactList = listOf(ContactWithFilter(contact = Contact(name = TEST_NAME), filterWithFilteredNumber = FilterWithFilteredNumber(filter = Filter(filterType = Constants.BLOCKER))), ContactWithFilter(contact = Contact(name = "zxy")))
        ...
        val expectedContactList = listOf(
            ContactWithFilter(contact = Contact(name = TEST_NAME), filterWithFilteredNumber = FilterWithFilteredNumber(filter = Filter(filterType = Constants.BLOCKER))))
