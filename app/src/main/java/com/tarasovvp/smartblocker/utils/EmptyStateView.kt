...
class EmptyStateView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0):
    ...
    init {
        ...
        binding?.emptyStateDescription?.text = if (descriptionRes > 0) context.getString(descriptionRes) else String.EMPTY
        a.recycle()
        visibility = GONE
    }
