...
enum class FilterAction(val title: Int, val color: Int, val icon: Int, val descriptionText: Int, val requestText: Int, val successText: Int) {
    ...
    FILTER_ACTION_PERMISSION_CHANGE(R.string.change, android.R.color.holo_orange_light, R.drawable.ic_white_to_black_filter, R.string.number_transfer_to_blocker_description, R.string.number_transfer_to_blocker_request, R.string.number_transfer_to_blocker_success),
    FILTER_ACTION_BLOCKER_CHANGE(R.string.change, android.R.color.holo_orange_light, R.drawable.ic_black_to_white_filter, R.string.number_transfer_to_permission_description, R.string.number_transfer_to_permission_request, R.string.number_transfer_to_permission_success);
}