...
enum class FilterAction(val title: Int, val color: Int, val icon: Int, val descriptionText: Int, val requestText: Int, val successText: Int) {
    FILTER_ACTION_INVALID(R.string.add, R.color.nobel, R.drawable.ic_black_filter_inactive, R.string.filter_description_invalid,0,0),
    FILTER_ACTION_BLOCKER_ADD(R.string.add, R.color.button_bg, R.drawable.ic_blocker, R.string.number_add_to_blocker_description, R.string.number_add_to_blocker_request,R.string.number_add_to_blocker_success),
    FILTER_ACTION_PERMISSION_ADD(R.string.add, R.color.button_bg, R.drawable.ic_permission, R.string.number_add_to_permission_description, R.string.number_add_to_permission_request,R.string.number_add_to_permission_success),
