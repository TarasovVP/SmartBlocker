package com.tarasovvp.smartblocker.presentation.mappersImpl
...
class ContactWithFilterMapperImpl: ContactWithFilterMapper {

    override fun mapToUIModel(contactWithFilter: ContactWithFilter): ContactWithFilterUIModel {
    ...
    override fun mapFromUIModel(contactWithFilterUIModel: ContactWithFilterUIModel): ContactWithFilter {
