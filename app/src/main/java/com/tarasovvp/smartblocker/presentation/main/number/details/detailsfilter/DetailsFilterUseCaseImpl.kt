...
constructor(
    ...
    override suspend fun allContactsWithFiltersByFilter(filter: String) =
        contactRepository.allContactsWithFiltersByFilter(filter)

    override suspend fun allFilteredCallsByFilter(filter: String) =
        filteredCallRepository.allFilteredCallsByFilter(filter)
