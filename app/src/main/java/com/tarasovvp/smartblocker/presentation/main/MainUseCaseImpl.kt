...
class MainUseCaseImpl
    ...
    constructor(
        ...
        override suspend fun getSystemCountryCodes(result: (Int, Int) -> Unit) =
            countryCodeRepository.getSystemCountryCodeList { size, position ->
        ...
        override suspend fun getSystemContacts(
            application: Application,
            result: (Int, Int) -> Unit,
        ): ArrayList<Contact> {
            val country =
                dataStoreRepository.getCountryCode().first()?.country.takeIf {
                    it.isNullOrEmpty().not()
                } ?: application.getUserCountry().orEmpty().uppercase()
        ...
        override suspend fun getSystemLogCalls(
            application: Application,
            result: (Int, Int) -> Unit,
        ): List<LogCall> {
            val country =
