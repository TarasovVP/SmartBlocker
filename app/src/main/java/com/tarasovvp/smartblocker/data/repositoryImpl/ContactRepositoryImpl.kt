...
class ContactRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun insertAllContacts(contactList: List<Contact>) = contactDao.insertAllContacts(contactList)

        override suspend fun allContactWithFilters() = contactDao.allContactsWithFilters()

        override suspend fun allContactsWithFiltersByFilter(filter: String) = contactDao.allContactsWithFiltersByFilter(filter)

        override suspend fun allContactsWithFiltersByCreateFilter(filter: String) = contactDao.allContactsWithFiltersByCreateFilter(filter)
    }
